...
var Preloader = new Class( {
	...
	*/
	...
	parseOptions: function(options) {
		return {
			imageAsBlob: options.imageAsBlob || false,
	...
	*/
	add: function( url ) {
		if (url) {
			this.addFromLoaderType( url, this._getLoader( url ) );
		}
	},
	...
	*/
	addImage: function( url ) {
		...
		this.addFromLoaderType( url, LoaderImage );
	},
	...
	*/
	addJSON: function( url ) {
		...
		this.addFromLoaderType( url, LoaderJSON );
	},
	...
	*
	*/
	addText: function( url ) {

		this.addFromLoaderType( url, LoaderText );
	},
	...
	*/
	addVideo: function( url ) {
		...
		this.addFromLoaderType( url, LoaderVideo );
	},
	...
	*/
	addAudio: function( url ) {
		...
		this.addFromLoaderType( url, LoaderAudio );
	},
	...
	*
	*/
	addFromLoaderType: function( url, LoaderType ) {

		if(!this.loaders[ url ]) {
			this.loaders[ url ] = new LoaderType(this.options);
			this.urls.push(url);
